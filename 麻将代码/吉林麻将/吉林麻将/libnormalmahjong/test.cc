...
//  	}
	...
	HandCards phc;
	CGameLogic cgl;
	cgl.AddCard(&phc, 0x03);
	cgl.AddCard(&phc, 0x04);
	cgl.AddCard(&phc, 0x05);
	...
	HandCards hc;	
	CGameLogic cgl;
	hc.ChangeableCards[0] = 0x5;
	hc.ChangeableCards[1] = 0x5;
	hc.ChangeableCards[2] = 0x5;
	hc.ChangeableCards[3] = 0x7;
	hc.ChangeableCards[4] = 0x28;
	hc.ChangeableCards[5] = 0x28;
	for (int i = 0; i < 27;i++)
	{
		hc.ChangeableCards[6] = x[i];
		hc.ChangeableCardsLen = 7;
		hc.FixedCardsLen = 0;
		bool ok;
