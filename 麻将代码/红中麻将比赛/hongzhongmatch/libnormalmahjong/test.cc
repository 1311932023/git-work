...
//  	}
	...
	HandCards hc;	
	CGameLogic cgl;
	hc.ChangeableCards[0] = 0x3;
	hc.ChangeableCards[1] = 0x3;	
	hc.ChangeableCards[2] = 0x3;
	hc.ChangeableCards[3] = 0x6;
	hc.ChangeableCards[4] = 0x9;
	hc.ChangeableCards[5] = 0x11;
	hc.ChangeableCards[6] = 0x13;
	hc.ChangeableCards[7] = 0x15;
	hc.ChangeableCards[8] = 0x18;

	hc.ChangeableCards[9] = 0x21;
	hc.ChangeableCards[10] = 0x22;
	hc.ChangeableCards[11] = 0x27;
	hc.ChangeableCards[12] = 0x27;
	...
	CardNode_set h;
	m_GameLogic.GetCardCount(&hc, h);
	const int FIXED_DEEP = 100;
	CardNode_package package;	
	m_GameLogic.AnalysisCardCount(FIXED_DEEP, h, package);	
