...
struct tm _tm; \
	...
	sprintf(_format, "|dbug|%d-%02d-%02d %02d:%02d:%02d.%06ld %s:%s:%d %s\n", 1900 + _tm.tm_year, 1 + _tm.tm_mon, _tm.tm_mday, _tm.tm_hour, \
...
struct tm _tm; \
	localtime_r(&_tv.tv_sec, &_tm); \
	sprintf(info_format, "|info|%d-%02d-%02d %02d:%02d:%02d.%06ld %s:%s:%d %s\n", 1900 + _tm.tm_year, 1 + _tm.tm_mon, _tm.tm_mday, _tm.tm_hour, \
	_tm.tm_min, _tm.tm_sec, _tv.tv_usec, __FILE__, __FUNCTION__, __LINE__, format); \
...
struct tm _tm; \
	localtime_r(&_tv.tv_sec, &_tm); \
	sprintf(info_format, "|warn|%d-%02d-%02d %02d:%02d:%02d.%06ld %s:%s:%d %s\n", 1900 + _tm.tm_year, 1 + _tm.tm_mon, _tm.tm_mday, _tm.tm_hour, \
	_tm.tm_min, _tm.tm_sec, _tv.tv_usec, __FILE__, __FUNCTION__, __LINE__, format); \
	Log::Instance().my_debug(info_format, ##__VA_ARGS__); \
}
...
struct tm _tm; \
	localtime_r(&_tv.tv_sec, &_tm); \
	sprintf(error_format, "|err|%d-%02d-%02d %02d:%02d:%02d.%06ld %s:%s:%d %s\n", 1900 + _tm.tm_year, 1 + _tm.tm_mon, _tm.tm_mday, _tm.tm_hour, \
	_tm.tm_min, _tm.tm_sec, _tv.tv_usec, __FILE__, __FUNCTION__, __LINE__, format); \
...
struct tm _tm; \
	localtime_r(&_tv.tv_sec, &_tm); \
	sprintf(error_format, "|fatal|%d-%02d-%02d %02d:%02d:%02d.%06ld %s:%s:%d %s\n", 1900 + _tm.tm_year, 1 + _tm.tm_mon, _tm.tm_mday, _tm.tm_hour, \
	_tm.tm_min, _tm.tm_sec, _tv.tv_usec, __FILE__, __FUNCTION__, __LINE__, format); \
	Log::Instance().my_debug(error_format, ##__VA_ARGS__); \
}
