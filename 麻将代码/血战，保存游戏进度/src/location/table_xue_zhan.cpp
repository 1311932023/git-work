#include "table_xue_zhan.h"
#include "../zjh.h"
#include "../common/log.h"

extern ZJH zjh;
extern Log log;
Table_xue_zhan::Table_xue_zhan()
{
...
void Table_xue_zhan::ConfInit_Remote(const Json::Value& val)
{
...
void Table_xue_zhan::GameEndReset()
{
	Table::GameEndReset();
	m_QuanBaoPlayer[0] = INVALID_CHAIRID;
	m_QuanBaoPlayer[1] = INVALID_CHAIRID;
...
// void Table_xue_zhan::GameEnd()
// {
// 	Table_zz_laizi::GameEnd();
// }

void Table_xue_zhan::Score_GameEndSucc(HuScoreSet& score, proto::game::AckGameEnd& stGameend)
{
...
void Table_xue_zhan::Proto_GameEndInfo(const MJ_user_buffer& UserID, proto::game::AckGameEnd& stGameend)
{
...
int Table_xue_zhan::OutCardEstimate(_uint8 ChairID, _uint8 bCard, MJ_major& major, int& fan_num)
{
...
int Table_xue_zhan::Check_Hu(_uint8 ChairID, HandCards& pHc, MJ_fan_buffer& oFan)
{
