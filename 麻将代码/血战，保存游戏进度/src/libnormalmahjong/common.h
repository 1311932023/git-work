...
#define FENG_DENG_MAX				(-100000000)

#define MAX_INDEX					(HAND_CARD_SIZE_MAX)
...
#define TYPE_CHUAI_GANG		0x8000								//踹杠
#define TYPE_CAI_GANG		0x10000								//东南西北
#define TYPE_CHUAI_CAI_GANG	0x20000								//踹彩杠
#define TYPE_CAI_GANG_X		(TYPE_CAI_GANG | TYPE_CHUAI_CAI_GANG)
#define TYPE_DATOUZI_ZHI	0x1000000
#define TYPE_DATOUZI_WAN	0x2000000
#define TYPE_DATOUZI_AN		0x4000000
...
#define TYPE_GANG_EXT		(TYPE_GANG | TYPE_DATOUZI_ZHI | TYPE_DATOUZI_AN | TYPE_DATOUZI_WAN)
#define TYPE_DATOUZI		(TYPE_DATOUZI_AN | TYPE_DATOUZI_ZHI | TYPE_DATOUZI_WAN)
...
struct HandCards
{
	...
	template<class Archive>
	void serialize(Archive & ar, const unsigned int /* file_version */) {
		printf("HandCards::serialize\n");
		ar & ChangeableCardsLen;
		ar & ChangeableCards;
		ar & FixedCardsLen;
		ar & FixedCards;
	}
