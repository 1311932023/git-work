...
enum client_command
{
	...
	CLIENT_SWITCH_STYLE_REQ      = 1026,        //切换桌面风格请求
	...
	//十堰卡五星
	CLIENT_ADD_ZENG_REQ 		 = 1120, //请求加增
	CLIENT_MJ_SHOW_REQ			 = 1121, //请求亮牌信息
	CLIENT_TRUSTEESHIP           = 1122, //托管请求
	//解散房间
    ...
    CLIENT_UPDATE_GPS_REQ        = 1300, //更新GPS信息请求
    CLIENT_GET_GPS_REQ           = 1301, //获取gps信息
...
//	CLIENT_PHZ_OPERATE_CARD_REQ	 = 1301,			//操作扑克
	...
	/* 麻将 */
	CLIENT_MJ_OUT_CARD_REQ       = 1402,			//出牌命令
	CLIENT_MJ_OPERATE_CARD_REQ   = 1403,			//玩家操作
	CLIENT_MJ_PIAO_REQ			 = 1404,			//飘操作
	CLIENT_MJ_FINAL_END_REQ	 	 = 1405,			//最终结算面板请求
	CLIENT_MJ_GAINS_REQ 		 = 1406,			//结算详情
};
...
enum server_command
{
	...
	SERVER_OPER_ERROR_UC 		     = 4232,        //用户操作失败
	...
	SERVER_UPDATE_GPS_BC        = 6000, //GPS信息
...
//	SERVER_PHZ_OPERATE_NOTIFY		= 6000,			//操作提示
	...
	/* 麻将游戏 */
	SERVER_FIRST_HANDCARD			= 6200,			//发送第一手手牌
	SERVER_USER_GETCARD				= 6201,			//玩家摸牌和出牌提示
	SERVER_USER_OUTCARD				= 6202,			//用户出牌结果回应
	SERVER_OPERATE_NOTIFY			= 6203,			//玩家操作提示
	SERVER_OPERATE_RESULT			= 6204,			//玩家操作返回通知
	SERVER_USER_HU					= 6205,			//玩家点胡
	SERVER_OPERATE_CARD_RES			= 6206,			//操作结果回应
	SERVER_OPERATE_RES				= 6207,			//操作回应
	SERVER_OVERTIME_USER			= 6308,			//玩家操作超时
	SERVER_LISTEN_NOTIFY			= 6309,			//听牌提示
	SERVER_LAIZI_INFO               = 6310,         //赖子牌信息
	SERVER_VIDEO_FIRST_HANDCARD     = 6311,         //录像第一手牌
	SERVER_UPDATE_USERINFO	 	    = 6312,         //更新玩家信息
};
