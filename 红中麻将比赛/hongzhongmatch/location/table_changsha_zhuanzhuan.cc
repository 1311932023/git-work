...
Table_cs_zhuanzhuan::Table_cs_zhuanzhuan()
{
	...
	m_trustee.get()->m_init_delay = m_bDelayTime;
	m_trustee.get()->m_init_timeout = m_timerout_Time;
	m_trustee.get()->m_auto_out_card = m_auto_out_trustee;	
