...
enum client_command
{
	...
	CLINET_MJ_CHECK_USER_HAND_CARD = 43001,//校验玩家手牌是否正确。
	//解散房间
...
enum server_command
{
	...
	//桂林转转
	SERVER_GUILING_SHOWZHUI    = 5076,		//桂林转转麻将通知客户端显示追
	SERVER_ROOM_KAIJIN_INFO    = 5077,      //云霄麻将开金
	SERVER_ROOM_YUNXIAO_JIN_HU = 5078,		//云霄麻将满足游金胡
	SER_CMD_OUT_CARD_ERR	   =5079,
	SER_CMD_STOP_OUT_CARD      = 5080 ,      //云霄麻将紧张出牌
