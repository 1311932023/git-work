...
void protobuf_AssignDesc_loginproto_5fmatch_2eproto() {
  ...
  static const int RankInfo_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RankInfo, avatar_),
  ...
  static const int DetailInfo_offsets_[9] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DetailInfo, totalscore_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DetailInfo, curturn_),
  };
...
void protobuf_AddDesc_loginproto_5fmatch_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "e\030\004 \001(\002\022\016\n\006avatar\030\005 \001(\t\022\013\n\003uid\030\006 \001(\005\"\032\n\n"
    "UpdateRank\022\014\n\004rank\030\001 \001(\005\"Y\n\tDetailAck\022(\n"
    "\010rankInfo\030\001 \003(\0132\026.proto.game.DetailInfo\022"
    "\017\n\007curRank\030\002 \001(\005\022\021\n\ttotalRank\030\003 \001(\005\"\254\001\n\n"
    "DetailInfo\022\r\n\005round\030\001 \001(\005\022\r\n\005score\030\002 \001(\005"
    "\022\021\n\troundRank\030\003 \001(\005\022\021\n\ttotalRank\030\004 \001(\005\022\020"
    "\n\010maxScore\030\005 \001(\005\022\020\n\010bestName\030\006 \001(\t\022\021\n\tbe"
    "stScore\030\007 \001(\005\022\022\n\ntotalScore\030\010 \001(\005\022\017\n\007cur"
    "turn\030\t \001(\005\"\303\001\n\rMatchTurnOver\022\022\n\nleft_tab"
    "le\030\001 \001(\005\022\020\n\010cur_rank\030\002 \001(\005\022*\n\010cur_turn\030\003"
    " \001(\0132\030.proto.game.NextTurnInfo\022+\n\tnext_t"
    "urn\030\004 \001(\0132\030.proto.game.NextTurnInfo\022\021\n\tp"
    "romotion\030\005 \001(\005\022\021\n\tleft_time\030\006 \001(\005\022\r\n\005sco"
    "re\030\007 \001(\005\"G\n\014NextTurnInfo\022\016\n\006turnid\030\001 \001(\005"
    "\022\020\n\010join_num\030\002 \001(\005\022\025\n\rpromotion_num\030\003 \001("
    "\005\"8\n\nAckRobotBc\022\013\n\003uid\030\001 \001(\005\022\016\n\006seatid\030\002"
    " \001(\005\022\r\n\005robot\030\003 \001(\005", 1019);
...
const int RankInfo::kAvatarFieldNumber;
...
const int DetailInfo::kTotalScoreFieldNumber;
const int DetailInfo::kCurturnFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_totalScore;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_curturn;
        break;
      }
...
void DetailInfo::SerializeWithCachedSizes(
  ...
  // optional int32 totalScore = 8;
  if (has_totalscore()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(8, this->totalscore(), output);
  }

  // optional int32 curturn = 9;
  if (has_curturn()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(9, this->curturn(), output);
  }
...
::google::protobuf::uint8* DetailInfo::SerializeWithCachedSizesToArray(
  ...
  // optional int32 totalScore = 8;
  if (has_totalscore()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(8, this->totalscore(), target);
  }

  // optional int32 curturn = 9;
  if (has_curturn()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(9, this->curturn(), target);
  }
...
void DetailInfo::Swap(DetailInfo* other) {
  if (other != this) {
    ...
    std::swap(curturn_, other->curturn_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
