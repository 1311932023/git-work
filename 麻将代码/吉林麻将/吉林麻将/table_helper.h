...
#define   NINGXIAG_MAJIAGN_GAME_ID   2252 
#define   XIAOHUA_MAJIAGN_GAME_ID    3010
#define   GUILIN_MAJIANG_GAME_ID     3030  
#define   JI_LIN_MAJIANG_GAME_ID     5070  
...
public:
	...
	_uint8 get_cur_pos()const { return m_Current; }
