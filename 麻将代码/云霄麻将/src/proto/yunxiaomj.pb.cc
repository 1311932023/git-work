...
const ::google::protobuf::Descriptor* AckUserStopOutCard_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  AckUserStopOutCard_reflection_ = NULL;
...
void protobuf_AssignDesc_yunxiaomj_2eproto() {
  ...
  static const int AckCustomiedInfo_offsets_[15] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckCustomiedInfo, chibanpai_),
  };
  ...
  static const int AckUserHuYouJin_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserHuYouJin, optypehutype_),
  };
  ...
  AckUserOutCardErr_descriptor_ = file->message_type(34);
  static const int AckUserOutCardErr_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserOutCardErr, card_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserOutCardErr, chairid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserOutCardErr, err_code_),
  };
  ...
  AckUserStopOutCard_descriptor_ = file->message_type(35);
  static const int AckUserStopOutCard_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserStopOutCard, chairid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserStopOutCard, stopoutcardflag_),
  };
  AckUserStopOutCard_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      AckUserStopOutCard_descriptor_,
      AckUserStopOutCard::default_instance_,
      AckUserStopOutCard_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserStopOutCard, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AckUserStopOutCard, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(AckUserStopOutCard));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    AckUserStopOutCard_descriptor_, &AckUserStopOutCard::default_instance());
}
...
void protobuf_ShutdownFile_yunxiaomj_2eproto() {
  ...
  delete AckUserStopOutCard::default_instance_;
  delete AckUserStopOutCard_reflection_;
}
...
void protobuf_AddDesc_yunxiaomj_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ckEnSureJoker\022\023\n\013GangCalcImm\030\016 \001(\010\022\021\n\tch"
    "ibanpai\030\020 \003(\005\"\232\002\n\023tagYunXiaomjGameEnd\022.\n"
    "\007faninfo\030\001 \003(\0132\035.proto.game.yunxiaomj.Fa"
    "nInfo\022\017\n\007piaoNum\030\002 \003(\005\022.\n\004Niao\030\003 \001(\0132 .p"
    "roto.game.yunxiaomj.tagJiangma\0224\n\006huinfo"
    "\030\004 \003(\0132$.proto.game.yunxiaomj.tagMultiHu"
    "Info\022\023\n\013LeftCardNum\030\005 \001(\005\022\033\n\023ContinuousB"
    "ankerNum\030\006 \003(\005\022\026\n\016RemainderCards\030\007 \003(\005\022\022"
    "\n\nYouJinType\030\010 \001(\005\"1\n\016tagMultiHuInfo\022\017\n\007"
    "Chairid\030\001 \002(\005\022\016\n\006HuCard\030\002 \003(\005\"-\n\nAddFanI"
    "nfo\022\017\n\007AddType\030\001 \001(\005\022\016\n\006AddNum\030\002 \001(\005\"q\n\007"
    "FanInfo\022\017\n\007chairID\030\001 \002(\005\022\023\n\013SpecialType\030"
    "\002 \002(\005\022\016\n\006FanNum\030\003 \002(\005\0220\n\006addfan\030\004 \003(\0132 ."
    "proto.game.yunxiaomj.AddFanInfo\"+\n\022tagBu"
    "ZhangOpResult\022\025\n\rBuzhangOpType\030\001 \002(\005\"\306\001\n"
    ...
    "Times\030\010 \001(\005\022\013\n\003Ex1\030\t \001(\005\022\013\n\003Ex2\030\n \001(\005\"\215\001"
    "\n\rGameEndRecord\0227\n\016UserRecoreInfo\030\001 \003(\0132"
    "\037.proto.game.yunxiaomj.ReordInfo\022\027\n\017Most"
    "DianPaoUser\030\002 \003(\005\022\030\n\020MostWinScoreUser\030\003 "
    "\003(\005\022\020\n\010DataTime\030\004 \001(\005\"\033\n\nRoundScore\022\r\n\005S"
    "core\030\001 \003(\005\"V\n\017TotalRoundScore\022/\n\005round\030\001"
    " \003(\0132 .proto.game.yunxiaomj.RoundScore\022\022"
    "\n\nroundcount\030\002 \001(\005\"H\n\017AckUserHuYouJin\022\017\n"
    "\007ChairID\030\001 \002(\005\022\016\n\006OpType\030\002 \001(\005\022\024\n\014OpType"
    "HuType\030\003 \001(\005\"D\n\021AckUserOutCardErr\022\014\n\004Car"
    "d\030\001 \001(\005\022\017\n\007ChairId\030\002 \001(\005\022\020\n\010Err_Code\030\003 \001"
    "(\005\">\n\022AckUserStopOutCard\022\017\n\007ChairId\030\001 \001("
    "\005\022\027\n\017StopOutCardFlag\030\002 \001(\010*I\n\tE_BUZHANG\022"
    "\023\n\017BUZHANG_ZHIGANG\020\002\022\023\n\017BUZHANG_WANGANG\020"
    "\004\022\022\n\016BUZHANG_ANGANG\020\010*\277\001\n\005E_GUI\022\021\n\rLAIZI"
    "_NOJOKER\020\000\022\026\n\022LAIZI_COMMON_JOKER\020\001\022\023\n\017LA"
    "IZI_FAN_JOKER\020\002\022\032\n\026LAIZI_FAN_DOUBLE_JOKE"
    "R\020\003\022\025\n\021LAIZI_HUA_JOKER_4\020\004\022\025\n\021LAIZI_HUA_"
    "JOKER_8\020\005\022\025\n\021LAIZI_HUA_JOKER_2\020\006\022\025\n\021LAIZ"
    "I_HUA_JOKER_6\020\007*\272\001\n\006HUGANG\022\017\n\013HUGANG_PEN"
  ...
  AckUserStopOutCard::default_instance_ = new AckUserStopOutCard();
  ...
  AckUserStopOutCard::default_instance_->InitAsDefaultInstance();
...
const int AckCustomiedInfo::kChibanpaiFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 14: {
        ...
        if (input->ExpectTag(128)) goto parse_chibanpai;
        break;
      }
      ...
      case 16: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_chibanpai:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 2, 128, input, this->mutable_chibanpai())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, this->mutable_chibanpai())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(128)) goto parse_chibanpai;
...
void AckCustomiedInfo::SerializeWithCachedSizes(
  ...
  // repeated int32 chibanpai = 16;
  for (int i = 0; i < this->chibanpai_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
      16, this->chibanpai(i), output);
  }
...
::google::protobuf::uint8* AckCustomiedInfo::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->chibanpai_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(16, this->chibanpai(i), target);
  }
...
int AckCustomiedInfo::ByteSize() const {
  ...
  // repeated int32 chibanpai = 16;
  {
    ...
    for (int i = 0; i < this->chibanpai_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->chibanpai(i));
    }
    total_size += 2 * this->chibanpai_size() + data_size;
  }
...
void AckCustomiedInfo::MergeFrom(const AckCustomiedInfo& from) {
  ...
  chibanpai_.MergeFrom(from.chibanpai_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
...
void AckCustomiedInfo::Swap(AckCustomiedInfo* other) {
  if (other != this) {
    ...
    chibanpai_.Swap(&other->chibanpai_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
const int AckUserHuYouJin::kOpTypeHuTypeFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_OpTypeHuType;
        break;
      }
...
void AckUserHuYouJin::SerializeWithCachedSizes(
  ...
  // optional int32 OpTypeHuType = 3;
  if (has_optypehutype()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->optypehutype(), output);
  }
...
::google::protobuf::uint8* AckUserHuYouJin::SerializeWithCachedSizesToArray(
  ...
  // optional int32 OpTypeHuType = 3;
  if (has_optypehutype()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->optypehutype(), target);
  }
...
const int AckUserOutCardErr::kChairIdFieldNumber;
const int AckUserOutCardErr::kErrCodeFieldNumber;
#endif  // !_MSC_VER
...
#ifndef _MSC_VER
const int AckUserStopOutCard::kChairIdFieldNumber;
const int AckUserStopOutCard::kStopOutCardFlagFieldNumber;
#endif  // !_MSC_VER

AckUserStopOutCard::AckUserStopOutCard()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void AckUserStopOutCard::InitAsDefaultInstance() {
}

AckUserStopOutCard::AckUserStopOutCard(const AckUserStopOutCard& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void AckUserStopOutCard::SharedCtor() {
  _cached_size_ = 0;
  chairid_ = 0;
...
void AckUserStopOutCard::SharedDtor() {
  if (this != default_instance_) {
  }
}

void AckUserStopOutCard::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* AckUserStopOutCard::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return AckUserStopOutCard_descriptor_;
}

const AckUserStopOutCard& AckUserStopOutCard::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_yunxiaomj_2eproto();
  return *default_instance_;
}

AckUserStopOutCard* AckUserStopOutCard::default_instance_ = NULL;

AckUserStopOutCard* AckUserStopOutCard::New() const {
  return new AckUserStopOutCard;
}

void AckUserStopOutCard::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    chairid_ = 0;
    stopoutcardflag_ = false;
  }
...
bool AckUserStopOutCard::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_StopOutCardFlag;
        break;
      }
      ...
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_StopOutCardFlag:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &stopoutcardflag_)));
...
void AckUserStopOutCard::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // optional int32 ChairId = 1;
  if (has_chairid()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(1, this->chairid(), output);
  ...
  // optional bool StopOutCardFlag = 2;
  if (has_stopoutcardflag()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(2, this->stopoutcardflag(), output);
  }
...
::google::protobuf::uint8* AckUserStopOutCard::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // optional int32 ChairId = 1;
  if (has_chairid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(1, this->chairid(), target);
  ...
  // optional bool StopOutCardFlag = 2;
  if (has_stopoutcardflag()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(2, this->stopoutcardflag(), target);
  }
...
int AckUserStopOutCard::ByteSize() const {
  int total_size = 0;
...
void AckUserStopOutCard::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const AckUserStopOutCard* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const AckUserStopOutCard*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void AckUserStopOutCard::MergeFrom(const AckUserStopOutCard& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_chairid()) {
      set_chairid(from.chairid());
    }
    if (from.has_stopoutcardflag()) {
      set_stopoutcardflag(from.stopoutcardflag());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}

void AckUserStopOutCard::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void AckUserStopOutCard::CopyFrom(const AckUserStopOutCard& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool AckUserStopOutCard::IsInitialized() const {

  return true;
}

void AckUserStopOutCard::Swap(AckUserStopOutCard* other) {
  if (other != this) {
    std::swap(chairid_, other->chairid_);
    std::swap(stopoutcardflag_, other->stopoutcardflag_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
::google::protobuf::Metadata AckUserStopOutCard::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = AckUserStopOutCard_descriptor_;
  metadata.reflection = AckUserStopOutCard_reflection_;
  return metadata;
}
