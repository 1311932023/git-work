...
enum client_command
{
	...
	CLIENT_JOIN_MATCH_REQ		 = 1001, //请求登录赛事
...
//	CLIENT_RANK_REQ              = 1080,
	...
	CLIENT_MJ_JIAMAI			 = 1112, //加买
	CLIENT_MJ_QISHOU_RESPOND	 = 1113, //起手胡应答
	CLIENT_MJ_YOUXI				 = 1114,
	CLIENT_MJ_HAIDI_YAO			 = 1115, //海底牌要不要

	CLIENT_QUIT_MATCH_REQ		 = 1222,//弃赛
	CLIENT_RANKLIST_REQ			 = 1230, //排行版
...
enum server_command
{
	...
	SERVER_GAME_START_UC			= 4231,	//发送手牌		
	//麻将游戏协议码
	...
	SERVER_HEART_BEAT_RES			= 5014, //心跳返回
	...
	//邛崃麻将
	SERVER_USER_LACK_TYPE_OK     = 5064,//邛崃麻将
	//来宾
	...
	//成都麻将
	SERVER_CHENGDU_START_DINGQUE = 5070,//成都麻将，开始定缺
	SERVER_CHENGDU_START_HUANZHANG = 5071,//成都麻将，开始换张
	SERVER_CHENGDU_USER_DINGQUE_DONE = 5072,//成都麻将，用户选完定缺色广播
	SERVER_CHENGDU_USER_HUANZHANG_DONE = 5073,//成都麻将，用户选完要换的张广播
	SERVER_CHENGDU_ALL_DINGQUE_DONE = 5074,//成都麻将，所有人定缺完成
	SERVER_CHENGDU_ALL_HUANZHANG_DONE = 5075,//成都麻将，所有人换张完成
	////镇江
	...
	//SERVER_NANCHANG_XIAJING		= 5075,		//下精牌结算
	//SERVER_KANGPING_GANGHUA		= 5076,//开局杠开翻牌
	//九江
	SERVER_JIUJIANG_JIAMAI		= 5079,		//加买消息
	SERVER_QISHOU_MSG			= 5080,//起手即胡牌
	SERVER_YOUXI				= 5081,
	SERVER_VEDIE_OP_NOTIFY		= 5082,//录像手牌
	SERVER_HAIDI_YAO			= 5083,//海底牌要不要	
	SERVER_ACK_ROUND_SCORE		= 6101,//战绩
	SERVER_PIAO_FEN				= 6102,//客户端飘分

	SERVER_CHANGE_RESULT		= 6103,		//广播换牌结果
	SERVER_DINGQUE_RESULT		= 6104,		//广播定缺结果
	SERVER_NEED_OUTCARD			= 6105 ,	//没操作需要出牌
	...
	SERVER_UPDATE_RANK_UC			= 5112, //更新个人排名
	SERVER_MATCH_END_BC				= 5113, //通知玩家所有玩家已完成所有赛事
	SERVER_TURN_OVER_BC				= 5114, //通知玩家当轮结束和下一轮信息
	SERVER_RANKLIST_ACK 			= 5115, //排行版返回
	SERVER_MATCH_PAUSE_BC 			= 5116, //比赛暂停
	SERVER_MATCH_CONTINUE_BC 		= 5117, //比赛继续
	SERVER_MATCH_PRIZE_UC 			= 5118, //比赛颁奖
	SERVER_NEXT_ROUND_UC 			= 5120,//进入下一轮
	SERVER_GAME_PAUSE_UC			= 5121,//比赛暂停返回
	SERVER_GAME_OVER_UC				= 5122,//时段赛所有牌打完
	// 与平台接口 
	SERVER_REGISTER_REQ				= 2001, //游戏服注册到平台tcp
	SERVER_REGISTER_ACK				= 2002, //注册返回
	SERVER_REGISTER_RES				= 2002,
	SERVER_MATCH_START_RES 			= 2003, //赛事开赛返回
	SERVER_MATCH_START_ACK 			= 2004, //平台通知游戏服赛事开赛
	SERVER_TURN_MP_INFO_REQ 		= 2005, //轮MP信息
	SERVER_GAME_SETTLE_REQ			= 2005,
	SERVER_TURN_MP_INFO_ACK 		= 2006, //MP信息返回
	SERVER_GAME_SETTLE_RES			= 2006,
	SERVER_TURN_RANK_INFO_REQ 		= 2007, //轮排名信息
	SERVER_TURN_RANK_REQ			= 2007,
	SERVER_TURN_RANK_INFO_ACK 		= 2008, //RANK信息返回
	SERVER_TURN_RANK_RES			= 2008,
	SERVER_TURN_MOVE_INFO_REQ 		= 2009, //轮移位信息
	SERVER_TURN_MOVE_INFO_ACK 		= 2010, //移位信息返回
	SERVER_MATCH_RANK_INFO_REQ 		= 2011, //赛事最终排名信息
	SERVER_LAST_RANK_REQ 			= 2011,
	SERVER_MATCH_RANK_INFO_ACK 		= 2012, //赛事最终排名信息返回
	SERVER_LAST_RANK_RES 			= 2012,
	SERVER_MATCH_EXCEPTION_REQ 		= 2013, //赛事异常请求
	SERVER_MATCH_EXCEPTION_ACK 		= 2014, //赛事异常请求返回
	SERVER_USER_OVER_REQ 			= 2015, //用户完成比赛
	SERVER_USER_END_REQ 			= 2015,
	SERVER_USER_OVER_ACK 			= 2016, //用户完成比赛返回
	SERVER_USER_END_RES 			= 2016,
	SERVER_USER_EXCEPTION_REQ 		= 2017, //用户异常请求
	SERVER_USER_EXCEPTION_ACK 		= 2018, //用户异常返回
	SERVER_MATCH_STATUS_REQ 		= 2019, //赛事状态请求
	SERVER_MATCH_STATUS_ACK 		= 2020, //赛事状态返回
	SERVER_MATCH_PAUSE_ACK 			= 2021, //平台请求暂停比赛返回
	SERVER_MATCH_PAUSE_REQ 			= 2022, //平台请求暂停比赛
	SERVER_MATCH_PRIZE_REQ			= 2024, //平台请求发奖
	SERVER_MATCH_SAVE_REQ 			= 2025, //赛事挂起保存数据
	SERVER_MATCH_SAVE_ACK 			= 2026, //赛事挂起保存数据返回
