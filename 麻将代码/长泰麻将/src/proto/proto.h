...
enum server_command
{
	...
	SERVER_GAME_BUHUA_HUAPAILIST     = 44007,//补花花牌列表
	SERVER_GAME_BUHUA_USERHUAPAILIST = 44008,//开局补花
	//麻将游戏协议码
	...
	SERVER_ROOM_KAIJIN_INFO    = 44002,      //云霄麻将开金
	SERVER_ROOM_YUNXIAO_JIN_HU = 5078,		//云霄麻将满足游金胡
	SERVER_ROOM_GENG_ZHUANG = 5079,   //湛江鬼牌
