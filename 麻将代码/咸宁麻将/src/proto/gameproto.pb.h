...
class ReqOutCard : public ::google::protobuf::Message {
 public:
  ...
  static const int kHongZhongLaiZiFlagFieldNumber = 3;
...
class AckGameScene : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_xianninggamescene() const;
  inline void clear_xianninggamescene();
  static const int kXianninggamesceneFieldNumber = 58;
  inline const ::proto::game::xianningmj::tagGameScene& xianninggamescene() const;
  inline ::proto::game::xianningmj::tagGameScene* mutable_xianninggamescene();
  inline ::proto::game::xianningmj::tagGameScene* release_xianninggamescene();
  inline void set_allocated_xianninggamescene(::proto::game::xianningmj::tagGameScene* xianninggamescene);
 ...
 private:
  ...
  inline void set_has_xianninggamescene();
  inline void clear_has_xianninggamescene();
  ...
  ::proto::game::xianningmj::tagGameScene* xianninggamescene_;
...
class AckOpNotify : public ::google::protobuf::Message {
 public:
  ...
  static const int kBAnHuGangFieldNumber = 9;
...
class AckGameEnd : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_xianninggameend() const;
  inline void clear_xianninggameend();
  static const int kXianningGameEndFieldNumber = 49;
  inline const ::proto::game::xianningmj::GameEndXianNing& xianninggameend() const;
  inline ::proto::game::xianningmj::GameEndXianNing* mutable_xianninggameend();
  inline ::proto::game::xianningmj::GameEndXianNing* release_xianninggameend();
  inline void set_allocated_xianninggameend(::proto::game::xianningmj::GameEndXianNing* xianninggameend);
 ...
 private:
  ...
  inline void set_has_xianninggameend();
  inline void clear_has_xianninggameend();
  ...
  ::proto::game::xianningmj::GameEndXianNing* xianninggameend_;
...
// optional .proto.game.xianningmj.tagGameScene xianninggamescene = 58;
inline bool AckGameScene::has_xianninggamescene() const {
  return (_has_bits_[1] & 0x02000000u) != 0;
}
inline void AckGameScene::set_has_xianninggamescene() {
  _has_bits_[1] |= 0x02000000u;
}
inline void AckGameScene::clear_has_xianninggamescene() {
  _has_bits_[1] &= ~0x02000000u;
}
inline void AckGameScene::clear_xianninggamescene() {
  if (xianninggamescene_ != NULL) xianninggamescene_->::proto::game::xianningmj::tagGameScene::Clear();
  clear_has_xianninggamescene();
}
inline const ::proto::game::xianningmj::tagGameScene& AckGameScene::xianninggamescene() const {
  return xianninggamescene_ != NULL ? *xianninggamescene_ : *default_instance_->xianninggamescene_;
}
inline ::proto::game::xianningmj::tagGameScene* AckGameScene::mutable_xianninggamescene() {
  set_has_xianninggamescene();
  if (xianninggamescene_ == NULL) xianninggamescene_ = new ::proto::game::xianningmj::tagGameScene;
  return xianninggamescene_;
}
inline ::proto::game::xianningmj::tagGameScene* AckGameScene::release_xianninggamescene() {
  clear_has_xianninggamescene();
  ::proto::game::xianningmj::tagGameScene* temp = xianninggamescene_;
  xianninggamescene_ = NULL;
  return temp;
}
inline void AckGameScene::set_allocated_xianninggamescene(::proto::game::xianningmj::tagGameScene* xianninggamescene) {
  delete xianninggamescene_;
  xianninggamescene_ = xianninggamescene;
  if (xianninggamescene) {
    set_has_xianninggamescene();
  } else {
    clear_has_xianninggamescene();
  }
...
// optional .proto.game.xianningmj.GameEndXianNing xianningGameEnd = 49;
inline bool AckGameEnd::has_xianninggameend() const {
  return (_has_bits_[1] & 0x00008000u) != 0;
}
inline void AckGameEnd::set_has_xianninggameend() {
  _has_bits_[1] |= 0x00008000u;
}
inline void AckGameEnd::clear_has_xianninggameend() {
  _has_bits_[1] &= ~0x00008000u;
}
inline void AckGameEnd::clear_xianninggameend() {
  if (xianninggameend_ != NULL) xianninggameend_->::proto::game::xianningmj::GameEndXianNing::Clear();
  clear_has_xianninggameend();
}
inline const ::proto::game::xianningmj::GameEndXianNing& AckGameEnd::xianninggameend() const {
  return xianninggameend_ != NULL ? *xianninggameend_ : *default_instance_->xianninggameend_;
}
inline ::proto::game::xianningmj::GameEndXianNing* AckGameEnd::mutable_xianninggameend() {
  set_has_xianninggameend();
  if (xianninggameend_ == NULL) xianninggameend_ = new ::proto::game::xianningmj::GameEndXianNing;
  return xianninggameend_;
}
inline ::proto::game::xianningmj::GameEndXianNing* AckGameEnd::release_xianninggameend() {
  clear_has_xianninggameend();
  ::proto::game::xianningmj::GameEndXianNing* temp = xianninggameend_;
  xianninggameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_xianninggameend(::proto::game::xianningmj::GameEndXianNing* xianninggameend) {
  delete xianninggameend_;
  xianninggameend_ = xianninggameend;
  if (xianninggameend) {
    set_has_xianninggameend();
  } else {
    clear_has_xianninggameend();
