...
#include "chongqinggameproto.pb.h"
...
class FixedCard : public ::google::protobuf::Message {
 public:
  ...
  inline int specialcard_size() const;
  inline void clear_specialcard();
  static const int kSpecialCardFieldNumber = 4;
  inline ::google::protobuf::int32 specialcard(int index) const;
  inline void set_specialcard(int index, ::google::protobuf::int32 value);
  inline void add_specialcard(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > specialcard_;
...
class AckGameScene : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_chongqingmjcustomied() const;
  inline void clear_chongqingmjcustomied();
  static const int kChongqingmjCustomiedFieldNumber = 59;
  inline const ::proto::game::chongqingmj::AckCustomiedInfoo& chongqingmjcustomied() const;
  inline ::proto::game::chongqingmj::AckCustomiedInfoo* mutable_chongqingmjcustomied();
  inline ::proto::game::chongqingmj::AckCustomiedInfoo* release_chongqingmjcustomied();
  inline void set_allocated_chongqingmjcustomied(::proto::game::chongqingmj::AckCustomiedInfoo* chongqingmjcustomied);

  // optional .proto.game.jiujiangmj.JiuJiangGameSence jiujiangGamesence = 60;
  inline bool has_jiujianggamesence() const;
  inline void clear_jiujianggamesence();
  static const int kJiujiangGamesenceFieldNumber = 60;
  inline const ::proto::game::jiujiangmj::JiuJiangGameSence& jiujianggamesence() const;
  inline ::proto::game::jiujiangmj::JiuJiangGameSence* mutable_jiujianggamesence();
  inline ::proto::game::jiujiangmj::JiuJiangGameSence* release_jiujianggamesence();
  inline void set_allocated_jiujianggamesence(::proto::game::jiujiangmj::JiuJiangGameSence* jiujianggamesence);

  // optional .proto.game.xuezhan.XueZhanGameSence xuezhanGameSence = 61;
  inline bool has_xuezhangamesence() const;
  inline void clear_xuezhangamesence();
  static const int kXuezhanGameSenceFieldNumber = 61;
  inline const ::proto::game::xuezhan::XueZhanGameSence& xuezhangamesence() const;
  inline ::proto::game::xuezhan::XueZhanGameSence* mutable_xuezhangamesence();
  inline ::proto::game::xuezhan::XueZhanGameSence* release_xuezhangamesence();
  inline void set_allocated_xuezhangamesence(::proto::game::xuezhan::XueZhanGameSence* xuezhangamesence);
 ...
 private:
  ...
  inline void set_has_chongqingmjcustomied();
  inline void clear_has_chongqingmjcustomied();
  inline void set_has_jiujianggamesence();
  inline void clear_has_jiujianggamesence();
  inline void set_has_xuezhangamesence();
  inline void clear_has_xuezhangamesence();
  ...
  ::proto::game::chongqingmj::AckCustomiedInfoo* chongqingmjcustomied_;
  ::proto::game::jiujiangmj::JiuJiangGameSence* jiujianggamesence_;
  ::proto::game::xuezhan::XueZhanGameSence* xuezhangamesence_;
...
class AckGameStart : public ::google::protobuf::Message {
 public:
  ...
  static const int kLianZhuangCountFieldNumber = 4;
...
class AckEnSureJoker : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_animtion() const;
  inline void clear_animtion();
  static const int kAnimtionFieldNumber = 7;
  inline const ::proto::game::nanchang::Animation& animtion() const;
  inline ::proto::game::nanchang::Animation* mutable_animtion();
  inline ::proto::game::nanchang::Animation* release_animtion();
  inline void set_allocated_animtion(::proto::game::nanchang::Animation* animtion);
 ...
 private:
  ...
  inline void set_has_leftcardnum();
  inline void clear_has_leftcardnum();
  inline void set_has_animtion();
  inline void clear_has_animtion();
  ...
  ::google::protobuf::int32 leftcardnum_;
  ::proto::game::nanchang::Animation* animtion_;
...
class AckUserGetCard : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_leftcardnum2() const;
  inline void clear_leftcardnum2();
  static const int kLeftCardNum2FieldNumber = 14;
  inline ::google::protobuf::int32 leftcardnum2() const;
  inline void set_leftcardnum2(::google::protobuf::int32 value);
  ...
  static const int kHuTypeFieldNumber = 15;
...
class AckOpNotify : public ::google::protobuf::Message {
 public:
  ...
  inline int chuaigang_size() const;
  inline void clear_chuaigang();
  static const int kChuaiGangFieldNumber = 9;
  inline const ::proto::game::tagGangInfo& chuaigang(int index) const;
  inline ::proto::game::tagGangInfo* mutable_chuaigang(int index);
  inline ::proto::game::tagGangInfo* add_chuaigang();
  inline const ::google::protobuf::RepeatedPtrField< ::proto::game::tagGangInfo >&
      chuaigang() const;
  inline ::google::protobuf::RepeatedPtrField< ::proto::game::tagGangInfo >*
      mutable_chuaigang();
  ...
  inline bool has_hu_type() const;
  inline void clear_hu_type();
  static const int kHuTypeFieldNumber = 10;
  inline ::google::protobuf::int32 hu_type() const;
  inline void set_hu_type(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::proto::game::hunanmj::tagBuZhang* bu_;
  ::google::protobuf::RepeatedPtrField< ::proto::game::tagPreGangs > xy_pregang_;
  ::google::protobuf::RepeatedPtrField< ::proto::game::tagGangInfo > chuaigang_;
  ::google::protobuf::int32 locklaizi_;
  ::google::protobuf::int32 hu_type_;
...
class AckOpNotifyVedio : public ::google::protobuf::Message {
 public:
  AckOpNotifyVedio();
  virtual ~AckOpNotifyVedio();

  AckOpNotifyVedio(const AckOpNotifyVedio& from);

  inline AckOpNotifyVedio& operator=(const AckOpNotifyVedio& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const AckOpNotifyVedio& default_instance();

  void Swap(AckOpNotifyVedio* other);

  // implements Message ----------------------------------------------

  AckOpNotifyVedio* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const AckOpNotifyVedio& from);
  void MergeFrom(const AckOpNotifyVedio& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline int optype_size() const;
  inline void clear_optype();
  static const int kOpTypeFieldNumber = 2;
  inline ::google::protobuf::int32 optype(int index) const;
  inline void set_optype(int index, ::google::protobuf::int32 value);
  inline void add_optype(::google::protobuf::int32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
      optype() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
      mutable_optype();

  // @@protoc_insertion_point(class_scope:proto.game.AckOpNotifyVedio)
 private:
  inline void set_has_chairid();
  inline void clear_has_chairid();
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > optype_;
  ::google::protobuf::int32 chairid_;
  ...
  void InitAsDefaultInstance();
  static AckOpNotifyVedio* default_instance_;
};
// -------------------------------------------------------------------
...
class AckBcOpResult : public ::google::protobuf::Message {
 public:
  ...
  inline int listeninfo_size() const;
  inline void clear_listeninfo();
  static const int kListenInfoFieldNumber = 12;
  inline const ::proto::game::tagListenInfo& listeninfo(int index) const;
  inline ::proto::game::tagListenInfo* mutable_listeninfo(int index);
  inline ::proto::game::tagListenInfo* add_listeninfo();
  inline const ::google::protobuf::RepeatedPtrField< ::proto::game::tagListenInfo >&
  ...
  inline bool has_curoutcarduser() const;
  inline void clear_curoutcarduser();
  static const int kCurOutCardUserFieldNumber = 13;
  inline ::google::protobuf::int32 curoutcarduser() const;
  inline void set_curoutcarduser(::google::protobuf::int32 value);

  // repeated int32 LockCards = 14;
  inline int lockcards_size() const;
  inline void clear_lockcards();
  static const int kLockCardsFieldNumber = 14;
  inline ::google::protobuf::int32 lockcards(int index) const;
  inline void set_lockcards(int index, ::google::protobuf::int32 value);
  inline void add_lockcards(::google::protobuf::int32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
      lockcards() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
      mutable_lockcards();
  ...
  inline int specialcard_size() const;
  inline void clear_specialcard();
  static const int kSpecialCardFieldNumber = 15;
  inline ::google::protobuf::int32 specialcard(int index) const;
  inline void set_specialcard(int index, ::google::protobuf::int32 value);
  inline void add_specialcard(::google::protobuf::int32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
 ...
 private:
  ...
  ::google::protobuf::int32 curoutcarduser_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > lockcards_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > specialcard_;
...
class AckGameEnd : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_chongqingendinfo() const;
  inline void clear_chongqingendinfo();
  static const int kChongqingEndInfoFieldNumber = 48;
  inline const ::proto::game::chongqingmj::tagChongQingGameEnd& chongqingendinfo() const;
  inline ::proto::game::chongqingmj::tagChongQingGameEnd* mutable_chongqingendinfo();
  inline ::proto::game::chongqingmj::tagChongQingGameEnd* release_chongqingendinfo();
  inline void set_allocated_chongqingendinfo(::proto::game::chongqingmj::tagChongQingGameEnd* chongqingendinfo);

  // optional .proto.game.ningdemj.NingeGameEnd ningeGameEnd = 49;
  inline bool has_ningegameend() const;
  inline void clear_ningegameend();
  static const int kNingeGameEndFieldNumber = 49;
  inline const ::proto::game::ningdemj::NingeGameEnd& ningegameend() const;
  inline ::proto::game::ningdemj::NingeGameEnd* mutable_ningegameend();
  inline ::proto::game::ningdemj::NingeGameEnd* release_ningegameend();
  inline void set_allocated_ningegameend(::proto::game::ningdemj::NingeGameEnd* ningegameend);

  // optional .proto.game.jiujiangmj.JiuJiangGameEnd JiuJiangGameEnd = 50;
  inline bool has_jiujianggameend() const;
  inline void clear_jiujianggameend();
  static const int kJiuJiangGameEndFieldNumber = 50;
  inline const ::proto::game::jiujiangmj::JiuJiangGameEnd& jiujianggameend() const;
  inline ::proto::game::jiujiangmj::JiuJiangGameEnd* mutable_jiujianggameend();
  inline ::proto::game::jiujiangmj::JiuJiangGameEnd* release_jiujianggameend();
  inline void set_allocated_jiujianggameend(::proto::game::jiujiangmj::JiuJiangGameEnd* jiujianggameend);

  // optional .proto.game.baohu.BaoHuGameEnd baohuGameEnd = 53;
  inline bool has_baohugameend() const;
  inline void clear_baohugameend();
  static const int kBaohuGameEndFieldNumber = 53;
  inline const ::proto::game::baohu::BaoHuGameEnd& baohugameend() const;
  inline ::proto::game::baohu::BaoHuGameEnd* mutable_baohugameend();
  inline ::proto::game::baohu::BaoHuGameEnd* release_baohugameend();
  inline void set_allocated_baohugameend(::proto::game::baohu::BaoHuGameEnd* baohugameend);

  // optional .proto.game.dongxiang.DongXiangGameEnd dongxiangGameEnd = 54;
  inline bool has_dongxianggameend() const;
  inline void clear_dongxianggameend();
  static const int kDongxiangGameEndFieldNumber = 54;
  inline const ::proto::game::dongxiang::DongXiangGameEnd& dongxianggameend() const;
  inline ::proto::game::dongxiang::DongXiangGameEnd* mutable_dongxianggameend();
  inline ::proto::game::dongxiang::DongXiangGameEnd* release_dongxianggameend();
  inline void set_allocated_dongxianggameend(::proto::game::dongxiang::DongXiangGameEnd* dongxianggameend);

  // optional .proto.game.antu.AnTuGameEnd antugameend = 55;
  inline bool has_antugameend() const;
  inline void clear_antugameend();
  static const int kAntugameendFieldNumber = 55;
  inline const ::proto::game::antu::AnTuGameEnd& antugameend() const;
  inline ::proto::game::antu::AnTuGameEnd* mutable_antugameend();
  inline ::proto::game::antu::AnTuGameEnd* release_antugameend();
  inline void set_allocated_antugameend(::proto::game::antu::AnTuGameEnd* antugameend);

  // optional .proto.game.daozhou.DaoZhouGameEnd daozhougameend = 56;
  inline bool has_daozhougameend() const;
  inline void clear_daozhougameend();
  static const int kDaozhougameendFieldNumber = 56;
  inline const ::proto::game::daozhou::DaoZhouGameEnd& daozhougameend() const;
  inline ::proto::game::daozhou::DaoZhouGameEnd* mutable_daozhougameend();
  inline ::proto::game::daozhou::DaoZhouGameEnd* release_daozhougameend();
  inline void set_allocated_daozhougameend(::proto::game::daozhou::DaoZhouGameEnd* daozhougameend);

  // optional .proto.game.yudu.YuDuGameEnd yudugameend = 57;
  inline bool has_yudugameend() const;
  inline void clear_yudugameend();
  static const int kYudugameendFieldNumber = 57;
  inline const ::proto::game::yudu::YuDuGameEnd& yudugameend() const;
  inline ::proto::game::yudu::YuDuGameEnd* mutable_yudugameend();
  inline ::proto::game::yudu::YuDuGameEnd* release_yudugameend();
  inline void set_allocated_yudugameend(::proto::game::yudu::YuDuGameEnd* yudugameend);
 ...
 private:
  ...
  inline void set_has_chongqingendinfo();
  inline void clear_has_chongqingendinfo();
  inline void set_has_ningegameend();
  inline void clear_has_ningegameend();
  inline void set_has_jiujianggameend();
  inline void clear_has_jiujianggameend();
  inline void set_has_baohugameend();
  inline void clear_has_baohugameend();
  inline void set_has_dongxianggameend();
  inline void clear_has_dongxianggameend();
  inline void set_has_antugameend();
  inline void clear_has_antugameend();
  inline void set_has_daozhougameend();
  inline void clear_has_daozhougameend();
  inline void set_has_yudugameend();
  inline void clear_has_yudugameend();
  ...
  ::proto::game::chongqingmj::tagChongQingGameEnd* chongqingendinfo_;
  ::proto::game::ningdemj::NingeGameEnd* ningegameend_;
  ::proto::game::jiujiangmj::JiuJiangGameEnd* jiujianggameend_;
  ::proto::game::baohu::BaoHuGameEnd* baohugameend_;
  ::proto::game::dongxiang::DongXiangGameEnd* dongxianggameend_;
  ::proto::game::antu::AnTuGameEnd* antugameend_;
  ::proto::game::daozhou::DaoZhouGameEnd* daozhougameend_;
  ::proto::game::yudu::YuDuGameEnd* yudugameend_;
...
class AckGameEnd_Chengdu : public ::google::protobuf::Message {
 public:
  AckGameEnd_Chengdu();
  virtual ~AckGameEnd_Chengdu();

  AckGameEnd_Chengdu(const AckGameEnd_Chengdu& from);

  inline AckGameEnd_Chengdu& operator=(const AckGameEnd_Chengdu& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const AckGameEnd_Chengdu& default_instance();

  void Swap(AckGameEnd_Chengdu* other);

  // implements Message ----------------------------------------------

  AckGameEnd_Chengdu* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const AckGameEnd_Chengdu& from);
  void MergeFrom(const AckGameEnd_Chengdu& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:proto.game.AckGameEnd_Chengdu)
 private:
  inline void set_has_endstate();
  inline void clear_has_endstate();
  ...
  void InitAsDefaultInstance();
  static AckGameEnd_Chengdu* default_instance_;
};
// -------------------------------------------------------------------
...
class tagUserState : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:proto.game.tagUserState)
 private:
  inline void set_has_chairid();
  inline void clear_has_chairid();
  inline void set_has_state();
...
// repeated int32 SpecialCard = 4;
inline int FixedCard::specialcard_size() const {
  return specialcard_.size();
}
inline void FixedCard::clear_specialcard() {
  specialcard_.Clear();
}
inline ::google::protobuf::int32 FixedCard::specialcard(int index) const {
  return specialcard_.Get(index);
}
inline void FixedCard::set_specialcard(int index, ::google::protobuf::int32 value) {
  specialcard_.Set(index, value);
}
inline void FixedCard::add_specialcard(::google::protobuf::int32 value) {
  specialcard_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
FixedCard::specialcard() const {
  return specialcard_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
FixedCard::mutable_specialcard() {
  return &specialcard_;
}
...
// optional .proto.game.chongqingmj.AckCustomiedInfoo chongqingmjCustomied = 59;
inline bool AckGameScene::has_chongqingmjcustomied() const {
  return (_has_bits_[1] & 0x02000000u) != 0;
}
inline void AckGameScene::set_has_chongqingmjcustomied() {
  _has_bits_[1] |= 0x02000000u;
}
inline void AckGameScene::clear_has_chongqingmjcustomied() {
  _has_bits_[1] &= ~0x02000000u;
}
inline void AckGameScene::clear_chongqingmjcustomied() {
  if (chongqingmjcustomied_ != NULL) chongqingmjcustomied_->::proto::game::chongqingmj::AckCustomiedInfoo::Clear();
  clear_has_chongqingmjcustomied();
}
inline const ::proto::game::chongqingmj::AckCustomiedInfoo& AckGameScene::chongqingmjcustomied() const {
  return chongqingmjcustomied_ != NULL ? *chongqingmjcustomied_ : *default_instance_->chongqingmjcustomied_;
}
inline ::proto::game::chongqingmj::AckCustomiedInfoo* AckGameScene::mutable_chongqingmjcustomied() {
  set_has_chongqingmjcustomied();
  if (chongqingmjcustomied_ == NULL) chongqingmjcustomied_ = new ::proto::game::chongqingmj::AckCustomiedInfoo;
  return chongqingmjcustomied_;
}
inline ::proto::game::chongqingmj::AckCustomiedInfoo* AckGameScene::release_chongqingmjcustomied() {
  clear_has_chongqingmjcustomied();
  ::proto::game::chongqingmj::AckCustomiedInfoo* temp = chongqingmjcustomied_;
  chongqingmjcustomied_ = NULL;
  return temp;
}
inline void AckGameScene::set_allocated_chongqingmjcustomied(::proto::game::chongqingmj::AckCustomiedInfoo* chongqingmjcustomied) {
  delete chongqingmjcustomied_;
  chongqingmjcustomied_ = chongqingmjcustomied;
  if (chongqingmjcustomied) {
    set_has_chongqingmjcustomied();
  } else {
    clear_has_chongqingmjcustomied();
  }
...
// optional .proto.game.jiujiangmj.JiuJiangGameSence jiujiangGamesence = 60;
inline bool AckGameScene::has_jiujianggamesence() const {
  return (_has_bits_[1] & 0x04000000u) != 0;
}
inline void AckGameScene::set_has_jiujianggamesence() {
  _has_bits_[1] |= 0x04000000u;
}
inline void AckGameScene::clear_has_jiujianggamesence() {
  _has_bits_[1] &= ~0x04000000u;
}
inline void AckGameScene::clear_jiujianggamesence() {
  if (jiujianggamesence_ != NULL) jiujianggamesence_->::proto::game::jiujiangmj::JiuJiangGameSence::Clear();
  clear_has_jiujianggamesence();
}
inline const ::proto::game::jiujiangmj::JiuJiangGameSence& AckGameScene::jiujianggamesence() const {
  return jiujianggamesence_ != NULL ? *jiujianggamesence_ : *default_instance_->jiujianggamesence_;
}
inline ::proto::game::jiujiangmj::JiuJiangGameSence* AckGameScene::mutable_jiujianggamesence() {
  set_has_jiujianggamesence();
  if (jiujianggamesence_ == NULL) jiujianggamesence_ = new ::proto::game::jiujiangmj::JiuJiangGameSence;
  return jiujianggamesence_;
}
inline ::proto::game::jiujiangmj::JiuJiangGameSence* AckGameScene::release_jiujianggamesence() {
  clear_has_jiujianggamesence();
  ::proto::game::jiujiangmj::JiuJiangGameSence* temp = jiujianggamesence_;
  jiujianggamesence_ = NULL;
  return temp;
}
inline void AckGameScene::set_allocated_jiujianggamesence(::proto::game::jiujiangmj::JiuJiangGameSence* jiujianggamesence) {
  delete jiujianggamesence_;
  jiujianggamesence_ = jiujianggamesence;
  if (jiujianggamesence) {
    set_has_jiujianggamesence();
  } else {
    clear_has_jiujianggamesence();
  }
...
// optional .proto.game.xuezhan.XueZhanGameSence xuezhanGameSence = 61;
inline bool AckGameScene::has_xuezhangamesence() const {
  return (_has_bits_[1] & 0x08000000u) != 0;
}
inline void AckGameScene::set_has_xuezhangamesence() {
  _has_bits_[1] |= 0x08000000u;
}
inline void AckGameScene::clear_has_xuezhangamesence() {
  _has_bits_[1] &= ~0x08000000u;
}
inline void AckGameScene::clear_xuezhangamesence() {
  if (xuezhangamesence_ != NULL) xuezhangamesence_->::proto::game::xuezhan::XueZhanGameSence::Clear();
  clear_has_xuezhangamesence();
}
inline const ::proto::game::xuezhan::XueZhanGameSence& AckGameScene::xuezhangamesence() const {
  return xuezhangamesence_ != NULL ? *xuezhangamesence_ : *default_instance_->xuezhangamesence_;
}
inline ::proto::game::xuezhan::XueZhanGameSence* AckGameScene::mutable_xuezhangamesence() {
  set_has_xuezhangamesence();
  if (xuezhangamesence_ == NULL) xuezhangamesence_ = new ::proto::game::xuezhan::XueZhanGameSence;
  return xuezhangamesence_;
}
inline ::proto::game::xuezhan::XueZhanGameSence* AckGameScene::release_xuezhangamesence() {
  clear_has_xuezhangamesence();
  ::proto::game::xuezhan::XueZhanGameSence* temp = xuezhangamesence_;
  xuezhangamesence_ = NULL;
  return temp;
}
inline void AckGameScene::set_allocated_xuezhangamesence(::proto::game::xuezhan::XueZhanGameSence* xuezhangamesence) {
  delete xuezhangamesence_;
  xuezhangamesence_ = xuezhangamesence;
  if (xuezhangamesence) {
    set_has_xuezhangamesence();
  } else {
    clear_has_xuezhangamesence();
...
// optional int32 lianZhuangCount = 4;
inline bool AckGameStart::has_lianzhuangcount() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void AckGameStart::set_has_lianzhuangcount() {
  _has_bits_[0] |= 0x00000008u;
}
inline void AckGameStart::clear_has_lianzhuangcount() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void AckGameStart::clear_lianzhuangcount() {
  lianzhuangcount_ = 0;
  clear_has_lianzhuangcount();
}
inline ::google::protobuf::int32 AckGameStart::lianzhuangcount() const {
  return lianzhuangcount_;
}
inline void AckGameStart::set_lianzhuangcount(::google::protobuf::int32 value) {
...
// optional .proto.game.nanchang.Animation animtion = 7;
inline bool AckEnSureJoker::has_animtion() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void AckEnSureJoker::set_has_animtion() {
  _has_bits_[0] |= 0x00000040u;
}
inline void AckEnSureJoker::clear_has_animtion() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void AckEnSureJoker::clear_animtion() {
  if (animtion_ != NULL) animtion_->::proto::game::nanchang::Animation::Clear();
  clear_has_animtion();
}
inline const ::proto::game::nanchang::Animation& AckEnSureJoker::animtion() const {
  return animtion_ != NULL ? *animtion_ : *default_instance_->animtion_;
}
inline ::proto::game::nanchang::Animation* AckEnSureJoker::mutable_animtion() {
  set_has_animtion();
  if (animtion_ == NULL) animtion_ = new ::proto::game::nanchang::Animation;
  return animtion_;
}
inline ::proto::game::nanchang::Animation* AckEnSureJoker::release_animtion() {
  clear_has_animtion();
  ::proto::game::nanchang::Animation* temp = animtion_;
  animtion_ = NULL;
  return temp;
}
inline void AckEnSureJoker::set_allocated_animtion(::proto::game::nanchang::Animation* animtion) {
  delete animtion_;
  animtion_ = animtion;
  if (animtion) {
    set_has_animtion();
...
// optional int32 LeftCardNum2 = 14;
inline bool AckUserGetCard::has_leftcardnum2() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void AckUserGetCard::set_has_leftcardnum2() {
  _has_bits_[0] |= 0x00002000u;
}
inline void AckUserGetCard::clear_has_leftcardnum2() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void AckUserGetCard::clear_leftcardnum2() {
  leftcardnum2_ = 0;
  clear_has_leftcardnum2();
}
inline ::google::protobuf::int32 AckUserGetCard::leftcardnum2() const {
  return leftcardnum2_;
}
inline void AckUserGetCard::set_leftcardnum2(::google::protobuf::int32 value) {
  set_has_leftcardnum2();
  leftcardnum2_ = value;
}

// optional int32 hu_type = 15;
inline bool AckUserGetCard::has_hu_type() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void AckUserGetCard::set_has_hu_type() {
  _has_bits_[0] |= 0x00004000u;
}
inline void AckUserGetCard::clear_has_hu_type() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void AckUserGetCard::clear_hu_type() {
  hu_type_ = 0;
  clear_has_hu_type();
}
inline ::google::protobuf::int32 AckUserGetCard::hu_type() const {
  return hu_type_;
}
inline void AckUserGetCard::set_hu_type(::google::protobuf::int32 value) {
  set_has_hu_type();
  hu_type_ = value;
}
...
// repeated .proto.game.tagGangInfo ChuaiGang = 9;
inline int AckOpNotify::chuaigang_size() const {
  return chuaigang_.size();
}
inline void AckOpNotify::clear_chuaigang() {
  chuaigang_.Clear();
}
inline const ::proto::game::tagGangInfo& AckOpNotify::chuaigang(int index) const {
  return chuaigang_.Get(index);
}
inline ::proto::game::tagGangInfo* AckOpNotify::mutable_chuaigang(int index) {
  return chuaigang_.Mutable(index);
}
inline ::proto::game::tagGangInfo* AckOpNotify::add_chuaigang() {
  return chuaigang_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto::game::tagGangInfo >&
AckOpNotify::chuaigang() const {
  return chuaigang_;
}
inline ::google::protobuf::RepeatedPtrField< ::proto::game::tagGangInfo >*
AckOpNotify::mutable_chuaigang() {
  return &chuaigang_;
}

// optional int32 hu_type = 10;
inline bool AckOpNotify::has_hu_type() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void AckOpNotify::set_has_hu_type() {
  _has_bits_[0] |= 0x00000200u;
}
inline void AckOpNotify::clear_has_hu_type() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void AckOpNotify::clear_hu_type() {
  hu_type_ = 0;
  clear_has_hu_type();
}
inline ::google::protobuf::int32 AckOpNotify::hu_type() const {
  return hu_type_;
}
inline void AckOpNotify::set_hu_type(::google::protobuf::int32 value) {
  set_has_hu_type();
  hu_type_ = value;
}
...
// required int32 ChairID = 1;
inline bool AckOpNotifyVedio::has_chairid() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void AckOpNotifyVedio::set_has_chairid() {
  _has_bits_[0] |= 0x00000001u;
}
inline void AckOpNotifyVedio::clear_has_chairid() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void AckOpNotifyVedio::clear_chairid() {
  chairid_ = 0;
  clear_has_chairid();
}
inline ::google::protobuf::int32 AckOpNotifyVedio::chairid() const {
  return chairid_;
}
inline void AckOpNotifyVedio::set_chairid(::google::protobuf::int32 value) {
  set_has_chairid();
  chairid_ = value;
}

// repeated int32 OpType = 2;
inline int AckOpNotifyVedio::optype_size() const {
  return optype_.size();
}
inline void AckOpNotifyVedio::clear_optype() {
  optype_.Clear();
}
inline ::google::protobuf::int32 AckOpNotifyVedio::optype(int index) const {
  return optype_.Get(index);
}
inline void AckOpNotifyVedio::set_optype(int index, ::google::protobuf::int32 value) {
  optype_.Set(index, value);
}
inline void AckOpNotifyVedio::add_optype(::google::protobuf::int32 value) {
  optype_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
AckOpNotifyVedio::optype() const {
  return optype_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
AckOpNotifyVedio::mutable_optype() {
  return &optype_;
}
...
// optional int32 CurOutCardUser = 13;
inline bool AckBcOpResult::has_curoutcarduser() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void AckBcOpResult::set_has_curoutcarduser() {
  _has_bits_[0] |= 0x00001000u;
}
inline void AckBcOpResult::clear_has_curoutcarduser() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void AckBcOpResult::clear_curoutcarduser() {
  curoutcarduser_ = 0;
  clear_has_curoutcarduser();
}
inline ::google::protobuf::int32 AckBcOpResult::curoutcarduser() const {
  return curoutcarduser_;
}
inline void AckBcOpResult::set_curoutcarduser(::google::protobuf::int32 value) {
  set_has_curoutcarduser();
  curoutcarduser_ = value;
}

// repeated int32 LockCards = 14;
inline int AckBcOpResult::lockcards_size() const {
  return lockcards_.size();
}
inline void AckBcOpResult::clear_lockcards() {
  lockcards_.Clear();
}
inline ::google::protobuf::int32 AckBcOpResult::lockcards(int index) const {
  return lockcards_.Get(index);
}
inline void AckBcOpResult::set_lockcards(int index, ::google::protobuf::int32 value) {
  lockcards_.Set(index, value);
}
inline void AckBcOpResult::add_lockcards(::google::protobuf::int32 value) {
  lockcards_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
AckBcOpResult::lockcards() const {
  return lockcards_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
AckBcOpResult::mutable_lockcards() {
  return &lockcards_;
}

// repeated int32 SpecialCard = 15;
inline int AckBcOpResult::specialcard_size() const {
  return specialcard_.size();
}
inline void AckBcOpResult::clear_specialcard() {
  specialcard_.Clear();
}
inline ::google::protobuf::int32 AckBcOpResult::specialcard(int index) const {
  return specialcard_.Get(index);
}
inline void AckBcOpResult::set_specialcard(int index, ::google::protobuf::int32 value) {
  specialcard_.Set(index, value);
}
inline void AckBcOpResult::add_specialcard(::google::protobuf::int32 value) {
  specialcard_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
AckBcOpResult::specialcard() const {
  return specialcard_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
AckBcOpResult::mutable_specialcard() {
  return &specialcard_;
}
...
// optional .proto.game.chongqingmj.tagChongQingGameEnd chongqingEndInfo = 48;
inline bool AckGameEnd::has_chongqingendinfo() const {
  return (_has_bits_[1] & 0x00008000u) != 0;
}
inline void AckGameEnd::set_has_chongqingendinfo() {
  _has_bits_[1] |= 0x00008000u;
}
inline void AckGameEnd::clear_has_chongqingendinfo() {
  _has_bits_[1] &= ~0x00008000u;
}
inline void AckGameEnd::clear_chongqingendinfo() {
  if (chongqingendinfo_ != NULL) chongqingendinfo_->::proto::game::chongqingmj::tagChongQingGameEnd::Clear();
  clear_has_chongqingendinfo();
}
inline const ::proto::game::chongqingmj::tagChongQingGameEnd& AckGameEnd::chongqingendinfo() const {
  return chongqingendinfo_ != NULL ? *chongqingendinfo_ : *default_instance_->chongqingendinfo_;
}
inline ::proto::game::chongqingmj::tagChongQingGameEnd* AckGameEnd::mutable_chongqingendinfo() {
  set_has_chongqingendinfo();
  if (chongqingendinfo_ == NULL) chongqingendinfo_ = new ::proto::game::chongqingmj::tagChongQingGameEnd;
  return chongqingendinfo_;
}
inline ::proto::game::chongqingmj::tagChongQingGameEnd* AckGameEnd::release_chongqingendinfo() {
  clear_has_chongqingendinfo();
  ::proto::game::chongqingmj::tagChongQingGameEnd* temp = chongqingendinfo_;
  chongqingendinfo_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_chongqingendinfo(::proto::game::chongqingmj::tagChongQingGameEnd* chongqingendinfo) {
  delete chongqingendinfo_;
  chongqingendinfo_ = chongqingendinfo;
  if (chongqingendinfo) {
    set_has_chongqingendinfo();
  } else {
    clear_has_chongqingendinfo();
...
// optional .proto.game.ningdemj.NingeGameEnd ningeGameEnd = 49;
inline bool AckGameEnd::has_ningegameend() const {
  return (_has_bits_[1] & 0x00010000u) != 0;
}
inline void AckGameEnd::set_has_ningegameend() {
  _has_bits_[1] |= 0x00010000u;
}
inline void AckGameEnd::clear_has_ningegameend() {
  _has_bits_[1] &= ~0x00010000u;
}
inline void AckGameEnd::clear_ningegameend() {
  if (ningegameend_ != NULL) ningegameend_->::proto::game::ningdemj::NingeGameEnd::Clear();
  clear_has_ningegameend();
}
inline const ::proto::game::ningdemj::NingeGameEnd& AckGameEnd::ningegameend() const {
  return ningegameend_ != NULL ? *ningegameend_ : *default_instance_->ningegameend_;
}
inline ::proto::game::ningdemj::NingeGameEnd* AckGameEnd::mutable_ningegameend() {
  set_has_ningegameend();
  if (ningegameend_ == NULL) ningegameend_ = new ::proto::game::ningdemj::NingeGameEnd;
  return ningegameend_;
}
inline ::proto::game::ningdemj::NingeGameEnd* AckGameEnd::release_ningegameend() {
  clear_has_ningegameend();
  ::proto::game::ningdemj::NingeGameEnd* temp = ningegameend_;
  ningegameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_ningegameend(::proto::game::ningdemj::NingeGameEnd* ningegameend) {
  delete ningegameend_;
  ningegameend_ = ningegameend;
  if (ningegameend) {
    set_has_ningegameend();
  } else {
    clear_has_ningegameend();
...
// optional .proto.game.jiujiangmj.JiuJiangGameEnd JiuJiangGameEnd = 50;
inline bool AckGameEnd::has_jiujianggameend() const {
  return (_has_bits_[1] & 0x00020000u) != 0;
}
inline void AckGameEnd::set_has_jiujianggameend() {
  _has_bits_[1] |= 0x00020000u;
}
inline void AckGameEnd::clear_has_jiujianggameend() {
  _has_bits_[1] &= ~0x00020000u;
}
inline void AckGameEnd::clear_jiujianggameend() {
  if (jiujianggameend_ != NULL) jiujianggameend_->::proto::game::jiujiangmj::JiuJiangGameEnd::Clear();
  clear_has_jiujianggameend();
}
inline const ::proto::game::jiujiangmj::JiuJiangGameEnd& AckGameEnd::jiujianggameend() const {
  return jiujianggameend_ != NULL ? *jiujianggameend_ : *default_instance_->jiujianggameend_;
}
inline ::proto::game::jiujiangmj::JiuJiangGameEnd* AckGameEnd::mutable_jiujianggameend() {
  set_has_jiujianggameend();
  if (jiujianggameend_ == NULL) jiujianggameend_ = new ::proto::game::jiujiangmj::JiuJiangGameEnd;
  return jiujianggameend_;
}
inline ::proto::game::jiujiangmj::JiuJiangGameEnd* AckGameEnd::release_jiujianggameend() {
  clear_has_jiujianggameend();
  ::proto::game::jiujiangmj::JiuJiangGameEnd* temp = jiujianggameend_;
  jiujianggameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_jiujianggameend(::proto::game::jiujiangmj::JiuJiangGameEnd* jiujianggameend) {
  delete jiujianggameend_;
  jiujianggameend_ = jiujianggameend;
  if (jiujianggameend) {
    set_has_jiujianggameend();
  } else {
    clear_has_jiujianggameend();
...
// optional .proto.game.baohu.BaoHuGameEnd baohuGameEnd = 53;
inline bool AckGameEnd::has_baohugameend() const {
  return (_has_bits_[1] & 0x00040000u) != 0;
}
inline void AckGameEnd::set_has_baohugameend() {
  _has_bits_[1] |= 0x00040000u;
}
inline void AckGameEnd::clear_has_baohugameend() {
  _has_bits_[1] &= ~0x00040000u;
}
inline void AckGameEnd::clear_baohugameend() {
  if (baohugameend_ != NULL) baohugameend_->::proto::game::baohu::BaoHuGameEnd::Clear();
  clear_has_baohugameend();
}
inline const ::proto::game::baohu::BaoHuGameEnd& AckGameEnd::baohugameend() const {
  return baohugameend_ != NULL ? *baohugameend_ : *default_instance_->baohugameend_;
}
inline ::proto::game::baohu::BaoHuGameEnd* AckGameEnd::mutable_baohugameend() {
  set_has_baohugameend();
  if (baohugameend_ == NULL) baohugameend_ = new ::proto::game::baohu::BaoHuGameEnd;
  return baohugameend_;
}
inline ::proto::game::baohu::BaoHuGameEnd* AckGameEnd::release_baohugameend() {
  clear_has_baohugameend();
  ::proto::game::baohu::BaoHuGameEnd* temp = baohugameend_;
  baohugameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_baohugameend(::proto::game::baohu::BaoHuGameEnd* baohugameend) {
  delete baohugameend_;
  baohugameend_ = baohugameend;
  if (baohugameend) {
    set_has_baohugameend();
  } else {
    clear_has_baohugameend();
...
// optional .proto.game.dongxiang.DongXiangGameEnd dongxiangGameEnd = 54;
inline bool AckGameEnd::has_dongxianggameend() const {
  return (_has_bits_[1] & 0x00080000u) != 0;
}
inline void AckGameEnd::set_has_dongxianggameend() {
  _has_bits_[1] |= 0x00080000u;
}
inline void AckGameEnd::clear_has_dongxianggameend() {
  _has_bits_[1] &= ~0x00080000u;
}
inline void AckGameEnd::clear_dongxianggameend() {
  if (dongxianggameend_ != NULL) dongxianggameend_->::proto::game::dongxiang::DongXiangGameEnd::Clear();
  clear_has_dongxianggameend();
}
inline const ::proto::game::dongxiang::DongXiangGameEnd& AckGameEnd::dongxianggameend() const {
  return dongxianggameend_ != NULL ? *dongxianggameend_ : *default_instance_->dongxianggameend_;
}
inline ::proto::game::dongxiang::DongXiangGameEnd* AckGameEnd::mutable_dongxianggameend() {
  set_has_dongxianggameend();
  if (dongxianggameend_ == NULL) dongxianggameend_ = new ::proto::game::dongxiang::DongXiangGameEnd;
  return dongxianggameend_;
}
inline ::proto::game::dongxiang::DongXiangGameEnd* AckGameEnd::release_dongxianggameend() {
  clear_has_dongxianggameend();
  ::proto::game::dongxiang::DongXiangGameEnd* temp = dongxianggameend_;
  dongxianggameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_dongxianggameend(::proto::game::dongxiang::DongXiangGameEnd* dongxianggameend) {
  delete dongxianggameend_;
  dongxianggameend_ = dongxianggameend;
  if (dongxianggameend) {
    set_has_dongxianggameend();
  } else {
    clear_has_dongxianggameend();
...
// optional .proto.game.antu.AnTuGameEnd antugameend = 55;
inline bool AckGameEnd::has_antugameend() const {
  return (_has_bits_[1] & 0x00100000u) != 0;
}
inline void AckGameEnd::set_has_antugameend() {
  _has_bits_[1] |= 0x00100000u;
}
inline void AckGameEnd::clear_has_antugameend() {
  _has_bits_[1] &= ~0x00100000u;
}
inline void AckGameEnd::clear_antugameend() {
  if (antugameend_ != NULL) antugameend_->::proto::game::antu::AnTuGameEnd::Clear();
  clear_has_antugameend();
}
inline const ::proto::game::antu::AnTuGameEnd& AckGameEnd::antugameend() const {
  return antugameend_ != NULL ? *antugameend_ : *default_instance_->antugameend_;
}
inline ::proto::game::antu::AnTuGameEnd* AckGameEnd::mutable_antugameend() {
  set_has_antugameend();
  if (antugameend_ == NULL) antugameend_ = new ::proto::game::antu::AnTuGameEnd;
  return antugameend_;
}
inline ::proto::game::antu::AnTuGameEnd* AckGameEnd::release_antugameend() {
  clear_has_antugameend();
  ::proto::game::antu::AnTuGameEnd* temp = antugameend_;
  antugameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_antugameend(::proto::game::antu::AnTuGameEnd* antugameend) {
  delete antugameend_;
  antugameend_ = antugameend;
  if (antugameend) {
    set_has_antugameend();
  } else {
    clear_has_antugameend();
...
// optional .proto.game.daozhou.DaoZhouGameEnd daozhougameend = 56;
inline bool AckGameEnd::has_daozhougameend() const {
  return (_has_bits_[1] & 0x00200000u) != 0;
}
inline void AckGameEnd::set_has_daozhougameend() {
  _has_bits_[1] |= 0x00200000u;
}
inline void AckGameEnd::clear_has_daozhougameend() {
  _has_bits_[1] &= ~0x00200000u;
}
inline void AckGameEnd::clear_daozhougameend() {
  if (daozhougameend_ != NULL) daozhougameend_->::proto::game::daozhou::DaoZhouGameEnd::Clear();
  clear_has_daozhougameend();
}
inline const ::proto::game::daozhou::DaoZhouGameEnd& AckGameEnd::daozhougameend() const {
  return daozhougameend_ != NULL ? *daozhougameend_ : *default_instance_->daozhougameend_;
}
inline ::proto::game::daozhou::DaoZhouGameEnd* AckGameEnd::mutable_daozhougameend() {
  set_has_daozhougameend();
  if (daozhougameend_ == NULL) daozhougameend_ = new ::proto::game::daozhou::DaoZhouGameEnd;
  return daozhougameend_;
}
inline ::proto::game::daozhou::DaoZhouGameEnd* AckGameEnd::release_daozhougameend() {
  clear_has_daozhougameend();
  ::proto::game::daozhou::DaoZhouGameEnd* temp = daozhougameend_;
  daozhougameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_daozhougameend(::proto::game::daozhou::DaoZhouGameEnd* daozhougameend) {
  delete daozhougameend_;
  daozhougameend_ = daozhougameend;
  if (daozhougameend) {
    set_has_daozhougameend();
  } else {
    clear_has_daozhougameend();
...
// optional .proto.game.yudu.YuDuGameEnd yudugameend = 57;
inline bool AckGameEnd::has_yudugameend() const {
  return (_has_bits_[1] & 0x00400000u) != 0;
}
inline void AckGameEnd::set_has_yudugameend() {
  _has_bits_[1] |= 0x00400000u;
}
inline void AckGameEnd::clear_has_yudugameend() {
  _has_bits_[1] &= ~0x00400000u;
}
inline void AckGameEnd::clear_yudugameend() {
  if (yudugameend_ != NULL) yudugameend_->::proto::game::yudu::YuDuGameEnd::Clear();
  clear_has_yudugameend();
}
inline const ::proto::game::yudu::YuDuGameEnd& AckGameEnd::yudugameend() const {
  return yudugameend_ != NULL ? *yudugameend_ : *default_instance_->yudugameend_;
}
inline ::proto::game::yudu::YuDuGameEnd* AckGameEnd::mutable_yudugameend() {
  set_has_yudugameend();
  if (yudugameend_ == NULL) yudugameend_ = new ::proto::game::yudu::YuDuGameEnd;
  return yudugameend_;
}
inline ::proto::game::yudu::YuDuGameEnd* AckGameEnd::release_yudugameend() {
  clear_has_yudugameend();
  ::proto::game::yudu::YuDuGameEnd* temp = yudugameend_;
  yudugameend_ = NULL;
  return temp;
}
inline void AckGameEnd::set_allocated_yudugameend(::proto::game::yudu::YuDuGameEnd* yudugameend) {
  delete yudugameend_;
  yudugameend_ = yudugameend;
  if (yudugameend) {
    set_has_yudugameend();
  } else {
    clear_has_yudugameend();
...
// repeated .proto.game.HandCards UserCard = 1;
inline int AckGameEnd_Chengdu::usercard_size() const {
  return usercard_.size();
}
inline void AckGameEnd_Chengdu::clear_usercard() {
  usercard_.Clear();
}
inline const ::proto::game::HandCards& AckGameEnd_Chengdu::usercard(int index) const {
  return usercard_.Get(index);
}
inline ::proto::game::HandCards* AckGameEnd_Chengdu::mutable_usercard(int index) {
  return usercard_.Mutable(index);
}
inline ::proto::game::HandCards* AckGameEnd_Chengdu::add_usercard() {
  return usercard_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto::game::HandCards >&
AckGameEnd_Chengdu::usercard() const {
  return usercard_;
}
inline ::google::protobuf::RepeatedPtrField< ::proto::game::HandCards >*
AckGameEnd_Chengdu::mutable_usercard() {
  return &usercard_;
}

// repeated int32 Score = 2;
inline int AckGameEnd_Chengdu::score_size() const {
  return score_.size();
}
inline void AckGameEnd_Chengdu::clear_score() {
  score_.Clear();
}
inline ::google::protobuf::int32 AckGameEnd_Chengdu::score(int index) const {
  return score_.Get(index);
}
inline void AckGameEnd_Chengdu::set_score(int index, ::google::protobuf::int32 value) {
  score_.Set(index, value);
}
inline void AckGameEnd_Chengdu::add_score(::google::protobuf::int32 value) {
  score_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
AckGameEnd_Chengdu::score() const {
  return score_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
AckGameEnd_Chengdu::mutable_score() {
  return &score_;
}

// optional int32 EndState = 3;
inline bool AckGameEnd_Chengdu::has_endstate() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void AckGameEnd_Chengdu::set_has_endstate() {
  _has_bits_[0] |= 0x00000004u;
}
inline void AckGameEnd_Chengdu::clear_has_endstate() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void AckGameEnd_Chengdu::clear_endstate() {
  endstate_ = 0;
  clear_has_endstate();
}
inline ::google::protobuf::int32 AckGameEnd_Chengdu::endstate() const {
  return endstate_;
}
inline void AckGameEnd_Chengdu::set_endstate(::google::protobuf::int32 value) {
  set_has_endstate();
  endstate_ = value;
}

// repeated .proto.game.tagEndGangInfo EndGangInfo = 4;
inline int AckGameEnd_Chengdu::endganginfo_size() const {
  return endganginfo_.size();
}
inline void AckGameEnd_Chengdu::clear_endganginfo() {
  endganginfo_.Clear();
}
inline const ::proto::game::tagEndGangInfo& AckGameEnd_Chengdu::endganginfo(int index) const {
  return endganginfo_.Get(index);
}
inline ::proto::game::tagEndGangInfo* AckGameEnd_Chengdu::mutable_endganginfo(int index) {
  return endganginfo_.Mutable(index);
}
inline ::proto::game::tagEndGangInfo* AckGameEnd_Chengdu::add_endganginfo() {
  return endganginfo_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto::game::tagEndGangInfo >&
AckGameEnd_Chengdu::endganginfo() const {
  return endganginfo_;
}
inline ::google::protobuf::RepeatedPtrField< ::proto::game::tagEndGangInfo >*
AckGameEnd_Chengdu::mutable_endganginfo() {
  return &endganginfo_;
}

// repeated .proto.game.FanInfo faninfo = 5;
inline int AckGameEnd_Chengdu::faninfo_size() const {
  return faninfo_.size();
}
inline void AckGameEnd_Chengdu::clear_faninfo() {
  faninfo_.Clear();
}
inline const ::proto::game::FanInfo& AckGameEnd_Chengdu::faninfo(int index) const {
  return faninfo_.Get(index);
}
inline ::proto::game::FanInfo* AckGameEnd_Chengdu::mutable_faninfo(int index) {
  return faninfo_.Mutable(index);
}
inline ::proto::game::FanInfo* AckGameEnd_Chengdu::add_faninfo() {
  return faninfo_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto::game::FanInfo >&
AckGameEnd_Chengdu::faninfo() const {
  return faninfo_;
}
inline ::google::protobuf::RepeatedPtrField< ::proto::game::FanInfo >*
AckGameEnd_Chengdu::mutable_faninfo() {
  return &faninfo_;
}

// repeated int32 money = 6;
inline int AckGameEnd_Chengdu::money_size() const {
  return money_.size();
}
inline void AckGameEnd_Chengdu::clear_money() {
  money_.Clear();
}
inline ::google::protobuf::int32 AckGameEnd_Chengdu::money(int index) const {
  return money_.Get(index);
}
inline void AckGameEnd_Chengdu::set_money(int index, ::google::protobuf::int32 value) {
  money_.Set(index, value);
}
inline void AckGameEnd_Chengdu::add_money(::google::protobuf::int32 value) {
  money_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
AckGameEnd_Chengdu::money() const {
  return money_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
AckGameEnd_Chengdu::mutable_money() {
  return &money_;
}
