...
{	
	...
	//MJ_FAN_TYPE_SPECIAL_MAX,	
		...
		//MJ_FAN_TYPE_DUIDUIHU,		            //对对胡 (手牌中除了一对对子，其余都是刻子)
		//MJ_FAN_TYPE_WUDUI,		                //五对 (请胡牌型)
		//MJ_FAN_TYPE_QINGYISEDUIDUIHU,		    //清一色对对胡
		//MJ_FAN_TYPE_QINGYISEDAIYAOJIU,		    //清一色带妖九
		//MJ_FAN_TYPE_JIANGDUIDUI,                //将对对
		//MJ_FAN_TYPE_QINGHU,                     //请胡达成
		//MJ_FAN_TYPE_BAOQINGHU,                  //报请胡达成
		//MJ_FAN_TYPE_GOUPAI,                     //勾数量
		//MJ_FAN_TYPE_BAOHU,                      //报胡
		//MJ_FAN_TYPE_ZHUABAOQINGHU,              //报请胡达成
		//MJ_FAN_TYPE_ZHUAQINGHU,                 //抓请胡
		//MJ_FAN_TYPE_ZHUABAOHU,                  //抓报胡
		//MJ_FAN_TYPE_DUANYAOJIU,                 //断妖九
		//MJ_FAN_TYPE_SIWULIUKA,                  //456卡
		//MJ_FAN_TYPE_PAOZHONGPAO,                //炮中炮
		//MJ_FAN_TYPE_HUAZHONGHUA,                //花中花
		//MJ_FAN_TYPE_JINGOUDIAO,                 //金钩钓
		//MJ_FAN_TYPE_ANQIDUI,				    //暗七对
		//MJ_FAN_TYPE_MAX,
		...
		MJ_FAN_TYPE_JIANGQIDUI = 47,				//将七对
		MJ_FAN_TYPE_GOUPAI = 48,			     	//勾牌
		MJ_FAN_TYPE_ZHONGZHANG = 49,                //中张
		MJ_FAN_TYPE_MENQING = 50,                   //门清
		MJ_FAN_TYPE_JINGOUHU = 51,                  //金钩胡
		MJ_FAN_TYPE_JIAXINWU = 52,                  //夹心五
		MJ_FAN_TYPE_SHUANGLONGQIDUI = 53,           //双龙七对
		MJ_FAN_TYPE_QINGSHUANGLONGQIDUI = 54,       //清双龙七对
		MJ_FAN_TYPE_QINGYISEJINGOUHU = 55,          //清一色金钩胡
		MJ_FAN_TYPE_JIANGDUIDUIJINGOUHU = 56,       //将对对金钩胡
...
class Fantype_to_FanNum
{
	...
	void serialize(Archive & ar, const unsigned int /* file_version */) {
		printf("Fantype_to_FanNum::serialize\n");
		ar & fan_num;
		ar & special_fan_num;
	}
protected:
...
BOOST_SERIALIZATION_ASSUME_ABSTRACT(Fantype_to_FanNum)
#endif
